...
/**
 * Component 7: CuratorsPicks
 * Limited 4-6 curated product preview cards for the collection.
 */
export const CuratorsPicks = ({ picks = [] }) => {
  if (!picks || picks.length === 0) return null;

  return (
    <div className="space-y-8">
      <SectionHeader
        tagline="Handpicked Masterpieces"
        title="Curator's Picks"
        subtitle="A limited preview of hallmark drapes selected by master fashion directors."
      />
          ...
          >
            ...
            <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
              <div className="space-y-1">
                ...
                <p className="text-base font-bold text-text-primary pt-1">
                  {item.price}
                </p>
              </div>
